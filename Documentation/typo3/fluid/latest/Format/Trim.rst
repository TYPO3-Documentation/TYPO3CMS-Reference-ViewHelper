...
..  Source: https://github.com/TYPO3/typo3/blob/main/typo3/sysext/fluid/Classes/ViewHelpers/Format/TrimViewHelper.php

:edit-on-github-link: https://github.com/TYPO3/typo3/edit/main/typo3/sysext/fluid/Classes/ViewHelpers/Format/TrimViewHelper.php
...
.. _typo3-fluid-format-trim_source:

Source code
===========

Go to the source code of this ViewHelper: `TrimViewHelper.php (GitHub) <https://github.com/TYPO3/typo3/blob/main/typo3/sysext/fluid/Classes/ViewHelpers/Format/TrimViewHelper.php>`__.
...
.. _typo3-fluid-format-trim-value_argument:

value
-----

..  confval:: value
    :name: typo3-fluid-format-trim-value
    :type: string
    :required: false

    The string value to be trimmed. If not given, the evaluated child nodes will be used.

.. _typo3-fluid-format-trim-characters_argument:

characters
----------

..  confval:: characters
    :name: typo3-fluid-format-trim-characters
    :type: string
    :required: false
...
.. _typo3-fluid-format-trim-side_argument:

side
----

..  confval:: side
    :name: typo3-fluid-format-trim-side
    :type: string
    :Default: 'both'
    :required: false
